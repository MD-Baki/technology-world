...
import { FaAngleDoubleRight, FaCheckSquare, FaStar, FaStarHalfAlt, FaDownload } from "react-icons/fa";
    ...
    return (
        <div className='corse-container'>
            <div className='download-btn'>
                <button onClick={handlePdfDownload} className='btn bg-[#2e5c83] hover:bg-[#2e5c83] border-0 text-lg'><FaDownload /></button>
            </div>
            <div className='py-12' id="courseContent">
