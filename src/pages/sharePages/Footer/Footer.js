...
const Footer = () => {
    return (
        <div className="bg-[#d6e6ee]">
            <div className="w-[1440px] mx-auto py-10 text-[#2e5c83] flex flex-wrap justify-between gap-4">
                <div className="logo-sec">
                    ...
                    <p className="pb-3">
                        We are ready to build your bright fyture.
                    </p>
                    <div>
                        <a
                            href="https://www.facebook.com/"
                            target="blank"
                            className="btn rounded-full btn-primary mr-3"
                        >
                            <FaFacebookF />
                        </a>
                        <a
